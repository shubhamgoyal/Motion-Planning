...
#define MIN_PEDESTRIAN_SPEED 1.0
#define MAX_PEDESTRIAN_SPEED 2.0

class Pedestrian_Behavior {
protected:
	void insert_new_long_term_goal (std::queue<pedestrian::action> &actions, State& pedestrian_state);
...
public:
	...
	void update_state (std::queue<pedestrian::action> &actions, double time_step, State& pedestrian_state);
